...
| QuantMZ_Heavy                            | the m/z of the peak of labeled data                                                                                                                              |
| Quant_Heavy                              | intensity peak data of labeled data                                                                                                                              |
...
| Correlation_Light_Heavy                  | Correlation calculated based on Pearson between unlabled and labled data peaks                                                                                   |
